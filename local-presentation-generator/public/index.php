...
<main>
  ...
  <?php if (is_array($result)): ?>
    <div class="alert alert--ok">
      ...
      <br><a class="download" href="<?= e((string)$result['download_url']) ?>">Скачать PPTX</a>
    </div>
  <?php endif; ?>
  ...
  <div class="layout">
    ...
    <aside class="panel">
      ...
      <p style="margin-top:16px;">
        <a class="download" href="/?action=open-output-folder">Открыть папку с презентациями в отдельном окне проводника</a>
      </p>
    </aside>
  </div>
</main>
