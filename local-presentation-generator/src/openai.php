...
function generatePresentationCardsWithOpenAi(string $apiKey, string $title, string $classTitle, array $sourceWords): array
{
    $payload = [
        ...
        'instructions' => implode("\n", [
            ...
            'For each English word, return source_word, english_word, transcription, hint in Russian, and image_prompt in English.',
        ]),
...
{
    $example = '{"cards":[{"source_word":"lion","english_word":"lion","transcription":"[ˈlaɪən]","hint":"Большая дикая кошка с гривой.","image_prompt":"A friendly lion standing in a sunny savanna, clear educational flashcard style, no text."}]}';
