...
define('GIGACHAT_AUTH_KEY', (string)(getenv('GIGACHAT_AUTH_KEY') ?: ''));
define('GIGACHAT_MODEL', (string)(getenv('GIGACHAT_MODEL') ?: 'GigaChat'));
define('GIGACHAT_IMAGE_MODEL', (string)(getenv('GIGACHAT_IMAGE_MODEL') ?: 'GigaChat'));
define('GIGACHAT_SCOPE', (string)(getenv('GIGACHAT_SCOPE') ?: 'GIGACHAT_API_PERS'));
define('GIGACHAT_AUTH_URL', rtrim((string)(getenv('GIGACHAT_AUTH_URL') ?: 'https://ngw.devices.sberbank.ru:9443/api/v2/oauth'), '/'));
define('GIGACHAT_API_BASE_URL', rtrim((string)(getenv('GIGACHAT_API_BASE_URL') ?: 'https://gigachat.devices.sberbank.ru/api/v1'), '/'));
$gigaChatVerifySsl = getenv('GIGACHAT_VERIFY_SSL');
define('GIGACHAT_VERIFY_SSL', $gigaChatVerifySsl === false ? '1' : (string)$gigaChatVerifySsl);
session_start();
