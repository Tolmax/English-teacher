  ...
  <div class="admin-shell" data-admin-shell>
    ...
    <aside class="admin-sidebar" id="admin-sidebar">
      ...
      <nav class="admin-sidebar__nav" aria-label="Админская навигация">
        <a class="admin-sidebar__link" href="<?= HOST ?>admin/teacher-guide"<?= $activeNav === 'teacher-guide' ? ' aria-current="page"' : '' ?>>📖 Руководство учителя</a>
        ...
        <a class="admin-sidebar__link" href="<?= HOST ?>admin/ai-materials"<?= $activeNav === 'ai-materials' ? ' aria-current="page"' : '' ?>>ИИ-создание теста</a>
