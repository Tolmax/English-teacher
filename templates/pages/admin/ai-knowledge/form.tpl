      ...
      <section class="stack" aria-labelledby="ai-knowledge-form-title">
        ...
        <form class="form card" action="<?= $actionUrl ?>" method="post" enctype="multipart/form-data" novalidate>
          ...
          <div class="form__field">
            ...
            <span class="form__hint" id="extracted-text-hint">Для текстового источника это обязательное поле. Для файла можно кратко добавить полезные фрагменты вручную.</span>
